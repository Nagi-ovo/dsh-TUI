...
// 固定窗:pacing —— FakeStdout 丢弃全部首帧，无法观察 Chat 与输入监听已挂载。
await sleep(600)
...
// 固定窗:探针 —— 须留窗让晚到乱码与延迟副作用显形，再断言历史、草稿和 rewind 均未改变。
await sleep(600)
