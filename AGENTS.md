...
pnpm install --frozen-lockfile  # pnpm 11.21.0（vendor/dsh-std 的 packageManager；corepack 下 11.24 会在 prepare 失败）；Node ^22.19 || >=24（CI 用 Node 24；.nvmrc / .node-version 钉 24）
