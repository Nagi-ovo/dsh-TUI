...
const dict = {
  ...
  'settings-badge-override': { zh: '用户', en: 'user' },
  ...
  'settings-hint-list': { zh: '←/→ 分类 · **Enter** 编辑/切换 · s 保存 · d 放弃 · Esc 放弃/退出', en: '←/→ categories · **Enter** edit/toggle · s save · d discard · Esc discard/exit' },
  'settings-hint-list-short': { zh: '**Enter** 编辑 · s 保存 · Esc 退出', en: '**Enter** edit · s save · Esc exit' },
  'settings-hint-edit': { zh: '**Enter** 确认 · Esc 取消', en: '**Enter** to confirm · Esc to cancel' },
  'settings-hint-edit-short': { zh: '**Enter** · Esc', en: '**Enter** · Esc' },
  'settings-hint-select': { zh: '↑/↓ 选择 · **Enter** 确认 · Esc 取消', en: '↑/↓ choose · **Enter** confirm · Esc cancel' },
