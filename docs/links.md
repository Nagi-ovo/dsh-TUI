...
| **YesPlayMusic ypm skill** | <https://github.com/nagi-studio/YesPlayMusic/tree/master/skills/dsh/ypm> | 让 dsh 的 agent 控制本机 YesPlayMusic 音乐播放：查询在放的歌、暂停/继续、切歌（SKILL.md 直接可用） |
